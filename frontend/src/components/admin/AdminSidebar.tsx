...
const adminSections: AdminSection[] = [
  {
    ...
    children: [
      { id: 'mission-control', title: 'Mission Control', icon: <Home className="w-4 h-4" />, path: '/admin/dashboard' },
      { id: 'analytics', title: 'Analytics', icon: <TrendingUp className="w-4 h-4" />, path: '/admin/analytics' },
      { id: 'notifications', title: 'Notifications', icon: <FileCheck className="w-4 h-4" />, path: '/admin/notifications' }
    ]
  },
  {
    id: 'user-management',
  ...
  },
  {
    ...
    children: [
      { id: 'system-health', title: 'System Health', icon: <Server className="w-4 h-4" />, path: '/admin/system/health' },
  ...
  },
  {
    ...
    children: [
      { id: 'materials', title: 'Materials', icon: <FileText className="w-4 h-4" />, path: '/admin/content/materials' },
  ...
  },
  {
    ...
    children: [
      { id: 'feature-flags', title: 'Feature Flags', icon: <Flag className="w-4 h-4" />, path: '/admin/dev/flags' },
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ collapsed, currentPath }) => {
  ...
  return (
    <div className={`fixed left-0 top-16 h-[calc(100vh-4rem)] bg-white border-r border-gray-200 transition-all duration-300 z-30 ${
      collapsed ? 'w-16' : 'w-64'
