            ...
            {Object.entries(groupedPermissions).map(([category, categoryPermissions]) => (
              <div key={category}>
                <h3 className="font-medium text-gray-900 mb-3 text-lg">
                  {category === 'user_management' ? 'Správa uživatelů' :
                   category === 'content_management' ? 'Správa obsahu' :
                   category === 'system_administration' ? 'Správa systému' :
                   category === 'financial_management' ? 'Finanční správa' :
